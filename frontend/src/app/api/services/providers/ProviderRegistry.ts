...
export class ProviderRegistry {
  ...
  async searchProduct(query: string, options?: { forceRefresh?: boolean, activeProviders?: string[], supplier?: { id: string; name: string; url: string; category: string } | null, listId?: string }): Promise<PriceResult> {
